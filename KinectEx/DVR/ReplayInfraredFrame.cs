...
namespace KinectEx.DVR
{
    ...
    {
        protected static byte[] _staticBytes = null;
        protected static ushort[] _staticData = null;

        protected ushort[] _frameData = null;
        ...
        public ReplayInfraredFrame(InfraredFrame frame)
        {
        ...
        public ReplayInfraredFrame(InfraredFrame frame, ushort[] frameData)
        {
            this.FrameType = FrameTypes.Infrared;
            this.RelativeTime = frame.RelativeTime;
        ...
        public static ReplayInfraredFrame FromReader(BinaryReader reader)
        {
