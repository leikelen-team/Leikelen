...
namespace KinectEx.DVR
{
    ...
    public class ReplayDepthFrame : ReplayFrame
    {
        ...
        public ReplayDepthFrame(DepthFrame frame)
        {
        ...
        public ReplayDepthFrame(DepthFrame frame, ushort[] frameData)
        {
            this.FrameType = FrameTypes.Depth;
            this.RelativeTime = frame.RelativeTime;
        ...
        public static ReplayDepthFrame FromReader(BinaryReader reader)
        {
