...
namespace Microsoft.Samples.Kinect.VisualizadorMultimodal.views
{
    ...
    /// </summary>
    public sealed class _GestureResultViewOld : INotifyPropertyChanged
    {
        ...
        private _GestureResultViewOld(int bodyIndex, bool isTracked, bool detected, float confidence)
        {
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence)
        {
            ...
            else
            {
                ...
                if (this.Detected)
                {
                    ...
                    //this.form.Label1 = "Sentao";                    
                }
                else
                {
                    this.ImageSource = this.notSeatedImage;
                    //this.form.Label1 = "Parao";
                }
            }
        }
