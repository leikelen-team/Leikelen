...
namespace cl.uv.leikelen.src.Helper
{
    public static class FileSystemUtils
    {
        ...
        {
            if (!Directory.Exists(CoreSettings.Instance.tmpDirectory)) Directory.CreateDirectory(CoreSettings.Instance.tmpDirectory);
            if (!Directory.Exists(CoreSettings.Instance.currentSceneDirectory)) Directory.CreateDirectory(CoreSettings.Instance.currentSceneDirectory);
