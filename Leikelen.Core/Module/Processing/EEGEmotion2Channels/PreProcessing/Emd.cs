...
/// <summary>
/// Preprocessing classes for classification of emotions of EEG.
/// </summary>
namespace cl.uv.leikelen.Module.Processing.EEGEmotion2Channels.PreProcessing
{
    ...
    public class Emd
    {
        ...
        public double[][] GetImfs(double[] data, int order, int iterations, int locality)
        {
            Emd emd = new Emd();
            EmdData emdData = emd.emdCreate(data.Length, order, iterations, locality);
        ...
        /*public static void main(String[] args)
        {
            ...
            emdDecompose(), and then using the structure's "imfs" field
