...
namespace cl.uv.leikelen.Data.Access.External
{
    class IntervalAccess : IIntervalAccess
    {
        ...
        public void FromEvent(int personId, string modalName, string subModalName, int millisecondsThreshold, int which, string intervalName)
        {
            ...
            foreach (var timeEvent in events)
            {
                ...
                {
                    Add(personId, modalName, intervalName, start.Value, end.Value);
                    start = timeEvent.EventTime;
                }
                end = timeEvent.EventTime;
